...
What we will want to load into RStudio is the raw data, which you can save in `.csv` format and in the `Data` directory in this R Project folder. If you need to update this analysis, simply save a new copy of the raw data with the same file names in the `Data` folder.
